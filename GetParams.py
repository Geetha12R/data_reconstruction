...
def get_args(*args):
    ...
    parser.add_argument('--wandb_project_name', default='Dataset_Reconstruction', help='')
    parser.add_argument('--wandb_entity', default='geetharanganathan', help='')
    parser.add_argument('--wandb_key', default='cff2550da0b6c88206b0172466e3c53cd1bdb9cd', help='wandb api key goes here')
    ...
    # model_train
    parser.add_argument('--metric', default='dssim', help='options:[dssim, mssim]')
    parser.add_argument('--cls_type', default='bi', help='options:[multi, bi]')
    parser.add_argument('--model_type', default='mlp', help='options: mlp')
    parser.add_argument('--model_train_pooling', default='max', help='options: max, average')
    parser.add_argument('--model_train_kernel', default=2, help='options: 2,3,5')
    ...
    parser.add_argument('--weight_decay', default=0.001, type=float, help='weight_decay is set to 0.001')
